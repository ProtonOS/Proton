...
constexpr UInt32 GDTDescriptorCount = 5;
constexpr UInt32 TSSDescriptorMax = 512 - GDTDescriptorCount;
...
namespace GDT
{
    ...
    void SetSegment(UInt32 pIndex, UInt32 pAddress, UInt32 pLimit, UInt8 pAccess, UInt8 pFlags)
    {
