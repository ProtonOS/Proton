 ...
 *
 *
 * Also, please note, this file has been modified slightly
 * for use in this project. Namely removing NACL support,
 * adding an include for "x86-codegen-extra.h" to include
 * some extra op-codes that we use, and switching to
 * #pragma once, from #ifndef, #define, #endif.
 *
 *
 *
 *
